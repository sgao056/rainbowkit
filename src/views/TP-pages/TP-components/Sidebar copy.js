...
import {dataPortal, dataNFT} from '../TP-constants/menu';

const menuItems = dataPortal.concat(dataNFT);
        ...
        >
          <div className="scroll">
            ...
            > 
              ...
              dataPortal
              ? 
              this.filteredList(dataPortal).map((item) => {
                return (
                  <>
                    <h3 className='m-0 p-0 font-weight-bold'>Portal</h3>
                    <Nav
                      key={item.id}
                              ...
                              {sub.newWindow ? (
                                ...
                                <NavLink to={sub.to}>
                                  <i className={sub.icon} />{' '}
                                  {
                                    ...
                                    <IntlMessages id={sub.label} style={{
                                      overflow: "hidden",
                                      whiteSpace: "nowrap"
                                    }}/>
                                    :
              ...
              dataNFT
              ? 
              this.filteredList(dataNFT).map((item) => {
                return (
                  <>
                    <h3 className='m-0 p-0 font-weight-bold'>NFT</h3>
                    <Nav
                      key={item.id}
                      className={classnames({
                        'd-block':
